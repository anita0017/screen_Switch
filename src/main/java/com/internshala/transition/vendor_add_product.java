...
public class vendor_add_product extends AppCompatActivity {
        ...
        try {
            ...
            dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    AddProduct cheff = snapshot.getValue(AddProduct.class);
...
//                    Area = cheff.getArea();
    ...
    private void uploadImage() {
        ...
        if(imageuri != null){
            final ProgressDialog progressDialog = new ProgressDialog(vendor_add_product.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(vendor_add_product.this,"Dish Posted Successfully!",Toast.LENGTH_SHORT).show();
                                }
                            });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(vendor_add_product.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                }
